 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://controller/", wsdlLocation = "http://192.168.0.59:8080/WEBPSP/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://controller/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.59:8080/WEBPSP/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://controller/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controller/", "NewWebServicePort"), NewWebService.class, features);
    }
