...
public class ObjectFactory {
    ...
    private final static QName _CorreoResponse_QNAME = new QName("http://WebService/", "correoResponse");
    private final static QName _Correo_QNAME = new QName("http://WebService/", "correo");
    ...
    /**
     * Create an instance of {@link Correo_Type }
     * 
     */
    public Correo_Type createCorreo_Type() {
        return new Correo_Type();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "correoResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Correo_Type }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "correo")
    public JAXBElement<Correo_Type> createCorreo(Correo_Type value) {
        return new JAXBElement<Correo_Type>(_Correo_QNAME, Correo_Type.class, null, value);
    }
